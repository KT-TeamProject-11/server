...
FAQ_ENTRIES = [
    ...
    },
    {
        "qs": [
            ...
            "센터 위치 어디야",
            "센터 운영시간 알려줘",
            # "주소" 넣으면 링크 부분에서 FAQ 내용이 나와서 주석처리했습니다. (범진)
        ],
        "answer": (
    ...
    },
    {
        ...
        "answer": (
            "센터 구성 및 각 팀의 담당자 연락처는 조직 및 담당 페이지에서 확인하실 수 있습니다.\n\n"
...
_WS = re.compile(r"\s+")
_ENDING = re.compile(r"(인가요|인가|이란|이야|예요|에요|요|줘|있어|\?)$")
