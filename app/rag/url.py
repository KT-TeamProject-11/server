# -*- coding: utf-8 -*-
"""
url.py — 천안URC 링크/주소 라우터 (자연어 질의 포괄 대응)

변경 요약
- 요청어(어디/확인/주소/링크 등)를 보존한 토큰으로 '페이지 요청' 의도 선판별
- '전문투어/일반투어' 등 자연어 → 코스별 링크 모음 브로드캐스트
- 문장부호 선제 제거, 동의어 대폭 확장, 투어 번호 규칙 강화
- 커뮤니티/도시재생+/아카이브/오시는길/프로그램 신청 문의를 최우선 라우팅과 잘 연결
"""
...
_REQ_TRAILER   = re.compile(
    r"(링크|url|주소|홈페이지|페이지|사이트|경로|바로가기"
    r"|어디(서|에서)? ?(봐|보|확인|찾아|들어가)(요)?"
    r"|어디(서|에서)?)$",
    re.IGNORECASE,
)
...
ENTRIES: List[UrlEntry] = [
    ...
    # ── 센터소개
    UrlEntry("센터소개 인사말","센터소개 > 인사말","센터 인사말 페이지입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/24","인사말")],
             aliases=["인사말","greeting"], page_ids=["24"]),
    UrlEntry("센터소개 목표와비전","센터소개 > 목표와 비전","센터의 목표와 비전 안내입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/79","목표와 비전")],
             aliases=["목표와 비전","비전","목표"], page_ids=["79"]),
    UrlEntry("센터소개 센터 연혁","센터소개 > 센터 연혁","센터 연혁 페이지입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/101","센터 연혁")],
             aliases=["연혁","센터연혁"], page_ids=["101"]),
    UrlEntry("센터소개 조직 및 담당","센터소개 > 조직 및 담당","조직도 및 담당자 안내입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/25","조직 및 담당")],
             aliases=["조직도","담당자","조직"], page_ids=["25"]),
    UrlEntry("센터소개 오시는길 천안시 도시재생지원센터","센터소개 > 오시는길 > 천안시 도시재생지원센터","센터 오시는 길 안내입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/131","오시는길(센터)")],
             aliases=["오시는길 센터","센터 오시는길","주소 센터","위치 센터","찾아오시는길 센터"], page_ids=["131"]),
    UrlEntry("센터소개 오시는길 봉평지구 도시재생현장지원센터","센터소개 > 오시는길 > 봉평지구 도시재생현장지원센터","봉평지구 현장지원센터 오시는 길입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/133","오시는길(봉평지구)")],
             aliases=["오시는길 봉평지구","봉평 오시는길","봉명 오시는길","위치 봉평","주소 봉평"], page_ids=["133"]),
    UrlEntry("센터소개 오시는길 오룡지구 도시재생현장지원센터","센터소개 > 오시는길 > 오룡지구 도시재생현장지원센터","오룡지구 현장지원센터 오시는 길입니다.",
    ...
    UrlEntry("사업소개 도시재생선도사업","사업소개 > 도시재생선도사업","도시재생선도사업 안내입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/27","도시재생선도사업")],
             aliases=["선도사업"], page_ids=["27"]),
    UrlEntry("사업소개 천안역세권 도시재생사업","사업소개 > 천안역세권 도시재생사업","천안역세권 도시재생사업 안내입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/71","역세권 도시재생사업")],
             aliases=["천안역세권 사업","역세권 사업"], page_ids=["71"]),
    UrlEntry("사업소개 남산지구 도시재생사업","사업소개 > 남산지구 도시재생사업","남산지구 도시재생사업 안내입니다.",
    ...
    # ── 도시재생+
    UrlEntry("도시재생플러스 공지사항","도시재생+ > 공지사항","도시재생+ 공지사항(전체/공지/채용/유관기관/기타) 목록입니다.",
             [LinkItem("https://www.cheonanurc.or.kr/new","공지사항(new)")],
             aliases=["도시재생+ 공지사항","공지사항","공지","채용공고","유관기관 공지"], page_ids=["new"]),
    UrlEntry("도시재생플러스 센터 프로그램 신청","도시재생+ > 센터 프로그램 신청","센터 프로그램 신청/모집 안내 목록입니다.",
