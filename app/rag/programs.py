...
_PROGRAMS = {
    ...
    "도시재생지원센터 천안시 도시재생지원센터 오시는 길": {
        ...
        "aliases": ["천안시도시재생지원센터오시는길", "도시재생지원센터오시는길", "천안시지원센터오는길", "천안시지원센터위치", "천안시센터위치"],
        "tags": ["오시는길", "오시는길", "가는길", "가는법"]
    },
    "도시재생지원센터 봉명지구 도시재생현장지원센터 오시는 길": {
        "url": "https://www.cheonanurc.or.kr/133",
        "aliases": ["봉명지구도시재생현장지원센터오시는길", "봉명지구현장지원센터오는길", "봉명지구지원센터위치", "봉명지구가는법", "봉명지구센터위치"],
        "tags": ["오시는길", "가는길", "가는법", "봉명지구", "현장지원센터"]
    },
    "도시재생지원센터 오룡지구 도시재생현장지원센터 오시는길": {
        "url": "https://www.cheonanurc.or.kr/128",
        "aliases": ["오룡지구 도시재생현장지원센터오시는길", "오룡지구 현장지원센터오는길", "오룡지구지원센터위치", "오룡지구가는법", "오룡지구센터위치"],
        "tags": ["오시는길", "가는길", "가는법", "오룡지구", "현장지원센터"]
    },
    ...
    "도시재생지원센터 봉명지구 도시재생현장지원센터": {
        ...
        "aliases": ["봉명지구도시재생현장지원센터", "봉명지구현장지원센터", "봉명지구커뮤니티"],
        "tags": ["현장지원센터", "봉명지구"]
    },
    "도시재생지원센터 오룡지구 도시재생현장지원센터": {
        "url": "https://www.cheonanurc.or.kr/121",
        "aliases": ["오룡지구도시재생현장지원센터", "오룡지구현장지원센터", "오룡지구커뮤니티"],
        "tags": ["현장지원센터", "오룡지구"]
    },
    ...
    "도시재생지원센터 센터 프로그램 신청": {
        ...
        "aliases": ["센터프로그램신청", "프로그램신청", "센터프로그램"],
        "tags": ["도시재생+", "도시재생플러스"]
    },
    "도시재생지원센터 도시재생 투어": {
